...
If ($PSReadLine -And $PSReadLine.Version.Minor -Ge 2)
{
    ...
    Set-PSReadLineOption -PredictionViewStyle ListView -AnsiEscapeTimeout 1000
}
ElseIf ($PSReadLine)
{
	Set-PSReadLineOption -Color @{
...
# Set Locale and Culture
Set-WinSystemLocale -SystemLocale "en-US"
Set-Culture -CultureInfo "en-US"
Set-PreferredLanguage -Language "en-US"
Set-SystemLanguage -Language "en-US" -ErrorAction Ignore -WarningAction Ignore
Set-SystemPreferredUILanguage -Language "en-US" -ErrorAction Ignore -WarningAction Ignore
Set-WinUILanguageOverride -Language "en-US" -ErrorAction Ignore -WarningAction Ignore
Uninstall-Language -Language "nb-NO" -ErrorAction Ignore -WarningAction Ignore

# Set Culture to en-US
[System.Reflection.Assembly]::Load('System.Management.Automation').GetType('Microsoft.PowerShell.NativeCultureResolver').GetField('m_Culture', 'NonPublic, Static').SetValue($null, ([System.Globalization.CultureInfo] "en-US"))
[System.Reflection.Assembly]::Load('System.Management.Automation').GetType('Microsoft.PowerShell.NativeCultureResolver').GetField('m_uiCulture', 'NonPublic, Static').SetValue($null, ([System.Globalization.CultureInfo] "en-US"))
...
Set-ItemProperty -Path "HKCU:\Control Panel\International" -Name iFirstWeekOfYear -Value 2
...
$UpTime = (Get-Date) - $OS
$HotFix = Get-HotFix | Sort-Object -Property InstalledOn -Descending | Select-Object -First 1 -ExpandProperty InstalledOn | Get-Date
$IPv4String = ''
...
If ($IPv4String.Length -Gt ([System.Console]::WindowWidth - 3 - 71))
{
    $IPv4String = $IPv4String.SubString(0, ([System.Console]::WindowWidth - 3 - 71))
    $IPv4String += "..."
} # If
$OldProgressPreference = $ProgressPreference
$ProgressPreference = "SilentlyContinue"
Write-Host -Object ""
If ($(Get-FQDNHostName) -Like "*")
{
# Start 1st line
"                    %%%%%" -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewline -ForegroundColor Red; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
" %%%%%%%%%%%%%       %%%%%%%%%" -Split '' | ForEach-Object {Write-Host -Object $_ -ForegroundColor White -NoNewline; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
...
"$($env:USERNAME)@$($env:USERDNSDOMAIN)`n" -Split '' | ForEach-Object {Write-Host -Object $_ -ForegroundColor Green -NoNewline; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
# End 2nd line
# Start 3rd line
"             %%%%%%%%%%%%" -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewline -ForegroundColor Red; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
" %%%%%%%%%%%%%%%     %%%%%%%%%" -Split '' | ForEach-Object {Write-Host -Object $_ -ForegroundColor White -NoNewline; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
" Host:          " -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewLine; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
"$(Get-FQDNHostName)$(If ((Get-WmiObject -Class Win32_ComputerSystem -Property Model | Select-Object -ExpandProperty Model) -NotLike "System*"){" [Model: $(Get-WmiObject -Class Win32_ComputerSystem -Property Model | Select-Object -ExpandProperty Model)]"}Else{" [Model: $(Get-WmiObject -Class Win32_BaseBoard -Property Product -ErrorAction Ignore -WarningAction Ignore | Select-Object -ExpandProperty Product)]"})`n" -Split '' | ForEach-Object {Write-Host -Object $_ -ForegroundColor DarkCyan -NoNewLine; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
# End 3rd line
# Start 4th line
"          %%%%%%%%%%%%%%%" -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewline -ForegroundColor DarkYellow; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
" %%%%%%%%%%%%%%%%    %%%%%%%%%" -Split '' | ForEach-Object {Write-Host -Object $_ -ForegroundColor White -NoNewline; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
...
{
    "$(Get-WmiObject -Class Win32_Processor -Property Name | Measure-Object | Select-Object -ExpandProperty Count)x $(Get-WmiObject -Class Win32_Processor -Property Name | Select-Object -ExpandProperty Name -Unique)`n" -Replace ' {1,}$', '' -Split '' | ForEach-Object {Write-Host -Object $_ -ForegroundColor Blue -NoNewLine; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
}
ElseIf ((Get-WmiObject -Class Win32_Processor -Property Name | Select-Object -ExpandProperty Name -Unique) -Match 'AMD')
{
    "$(Get-WmiObject -Class Win32_Processor -Property Name | Measure-Object | Select-Object -ExpandProperty Count)x $(Get-WmiObject -Class Win32_Processor -Property Name | Select-Object -ExpandProperty Name -Unique)`n" -Replace ' {1,}$', '' -Split '' | ForEach-Object {Write-Host -Object $_ -ForegroundColor Red -NoNewLine; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
}
# End 7th line
# Start 8th line
" %%%%%%%%%%%%%%%%%%%%%%%%" -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewline -ForegroundColor DarkYellow; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
...
# End 9th line
# Start 10th line
"  %%%%%%%%%%%%%%%%%%%%%%%" -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewline -ForegroundColor Yellow; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
" %%%%%%%%%      %%%%%%%%%%%%%%" -Split '' | ForEach-Object {Write-Host -Object $_ -ForegroundColor White -NoNewline; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
" IPv4 Adderss:  " -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewline; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
#"$((Get-NetIPInterface | Where-Object -FilterScript {$_.InterfaceAlias -NotLike "Loopback*"} | Get-NetIPAddress -AddressFamily IPv4 -ErrorAction Ignore -WarningAction Ignore | Where-Object -FilterScript {$_.IPAddress -NotLike "169.254.*"} | Select-Object -Property @{Name='Interface'; Expression={"$($_.InterfaceAlias): $($_.IPAddress)"}} | Select-Object -ExpandProperty Interface) -Join '; ')`n"
...
# End 11th line
# Start 12th line
" %%%%%%%%%%%%%%%%%%%%%%%%" -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewline -ForegroundColor Black; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
"%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%" -Split '' | ForEach-Object {Write-Host -Object $_ -ForegroundColor Black -NoNewline; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
...
ElseIf ($GPUs)
{
    If ($GPUs.Vendor -Match 'AMD' -Or $GPUs[$I].Vendor -Match 'ATI')
        ...
        {
            "$($GPUs.Model) [$(If (Get-WindowsDriver -Online -ErrorAction Ignore -WarningAction Ignore | Where-Object -FilterScript {$_.ClassName -Eq 'Display' -And $_.ProviderName -Like "Intel*"}){Get-WindowsDriver -Online | Where-Object -FilterScript {$_.ClassName -Eq 'Display' -And $_.ProviderName -Like "Intel*"} | Select-Object -Property Driver,ClassName,ProviderName,Date,Version | Sort-Object -Property Date -Descending | Select-Object -Unique -First 1 | Select-Object -ExpandProperty Version})]`n" -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewline -ForegroundColor Blue; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
        }
        ElseIf ($GPUs.Vendor -Match 'Nvidia')
        {
            "$($GPUs.Model)`n" -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewline -ForegroundColor Green; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
        }
        Else
        {
...
" DateTime:      " -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewline; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
"$(Get-Date -UFormat "%Y/%m/%d %r %Z")`n" -Split '' | ForEach-Object {Write-Host -Object $_ -ForegroundColor DarkYellow -NoNewLine; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
Remove-Variable -Name Append,Split,Str -ErrorAction Ignore -WarningAction Ignore
}
$ProgressPreference = $OldProgressPreference
Remove-Variable -Name GPUs,HotFix,I,OS,OldProgressPreference,ProfileItem,ProfileRepo,RepoItem,Random,SoundDevs,UpTime -ErrorAction Ignore -WarningAction Ignore


#Write-Host -Object "Uptime: " -NoNewLine
#Write-Host -Object "$($UpTime.ToString('dd\:hh\:mm\:ss'))" -ForegroundColor Yellow
#Write-Host -Object "Uptime: " -NoNewLine
#Write-Host -Object "$("{0:dd}d:{0:hh}h:{0:mm}m:{0:ss}s" -f ($UpTime))" -ForegroundColor White
#Write-Host -Object "User:   " -NoNewLine
#Write-Host -Object "$($env:USERNAME)@$($env:USERDNSDOMAIN)" -ForegroundColor Green
#Write-Host -Object "Host:   " -NoNewLine
#Write-Host -Object "$(Get-FQDNHostName)" -ForegroundColor DarkCyan
##Write-Host -Object "$($env:USERDOMAIN)\$($env:COMPUTERNAME)" -ForegroundColor DarkCyan
#Write-Host -Object "Date:   " -NoNewline
#Write-Host -Object "$(Get-Date -UFormat "%Y-%b-%d")" -ForegroundColor DarkYellow
#Write-Host -Object "Time:   " -NoNewline
#Write-Host -Object "$(Get-Date -UFormat "%r %Z")" -ForegroundColor DarkYellow
