...
If ($IPv4String.Length -Gt ([System.Console]::WindowWidth - 3 - 62))
{
    $IPv4String = $IPv4String.SubString(0, ([System.Console]::WindowWidth - 3 - 62))
    $IPv4String += "..."
} # If
...
Write-Host -Object ""
# Start 1st line
'              &(((((((((                      ' -Split '' | ForEach-Object {Write-Host -Object $_ -NoNewline -ForegroundColor Cyan; Start-Sleep -Milliseconds (Get-Random -Minimum 0 -Maximum 1)}
