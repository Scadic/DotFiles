...
Set-ItemProperty -Path 'HKCU:\Control Panel\International' -Name iFirstWeekOfYear -Value 0
...
Set-ItemProperty -Path 'HKCU:\Control Panel\International' -Name s1159 -Value 'AM'
Set-ItemProperty -Path 'HKCU:\Control Panel\International' -Name s2359 -Value 'PM'
...
Set-ItemProperty -Path 'HKCU:\Control Panel\International' -Name iCalendarType -Value 'dddd, dd MMMM, yyyy'
...
Set-ItemProperty -Path 'HKCU:\Control Panel\International' -Name sTime -Value ':'
...
If ($IPv4String.Length -Gt ([System.Console]::WindowWidth - 3 - 52))
{
    $IPv4String = $IPv4String.SubString(0, ([System.Console]::WindowWidth - 3 - 52))
    $IPv4String += "..."
} # If
